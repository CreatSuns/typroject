...
#import "TyBaseLoginHelper.h"
#import <LocalAuthentication/LocalAuthentication.h>
#import "SSKeychain.h"

@implementation TyBaseLoginHelper
...
{
    return [self setPassword:password ForService:TyLoginKeychain account:account];
}

+ (BOOL)deleteLoginPasswordForAccount:(NSString *)account
{
    return [self deletePasswordForService:TyLoginKeychain account:account];
}
...
{
    [self checkAccount:account serviceName:TyLoginKeychain resultBlock:block];
}

+ (BOOL)checkLoginAccount:(NSString *)account
{
    return [self checkLoginAccount:account serviceName:TyLoginKeychain];
}
