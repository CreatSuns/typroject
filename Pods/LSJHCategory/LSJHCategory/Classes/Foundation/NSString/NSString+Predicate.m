...
- (BOOL)ll_isOnlyChinese
{
    ...
    [NSPredicate predicateWithFormat:@"SELF MATCHES %@", chineseTest];
...
- (BOOL)ll_validateNickName
{
    ...
    [NSPredicate predicateWithFormat:@"SELF MATCHES %@", userNameRegex];
...
- (BOOL)ll_isValidIdentifyFifteen
{
    ...
    [NSPredicate predicateWithFormat:@"SELF MATCHES %@", identifyTest];
...
- (BOOL)ll_isCarNumber
{
    ...
    NSString * carRegex =
    @"^[\u4e00-\u9fff]{1}[a-zA-Z]{1}[-][a-zA-Z_0-9]{4}[a-zA-Z_0-9_\u4e00-\u9fff]"
    ...
    switch (length) {
        case 15:
            ...
            if (year % 4 == 0 || (year % 100 == 0 && year % 4 == 0)) {
                ...
                initWithPattern:@"^[1-9][0-9]{5}[0-9]{2}((01|03|05|07|08|10|12)(0[1-9]|[1-2][0-"
            ...
            numberofMatch =
            [regularExpression numberOfMatchesInString:value
        ...
        case 18:
            ...
            if (year % 4 == 0 || (year % 100 == 0 && year % 4 == 0)) {
                regularExpression = [[NSRegularExpression alloc]
                initWithPattern:@"^[1-9][0-9]{5}19[0-9]{2}((01|03|05|07|08|10|12)(0[1-9]|[1-2]["
                                @"0-9]|3[0-1])|(04|06|09|11)(0[1-9]|[1-2][0-9]|30)|02(0[1-9]|["
                                @"1-2][0-9]))[0-9]{3}[0-9Xx]$"
                        options:NSRegularExpressionCaseInsensitive
                          error:nil]; //测试出生日期的合法性
            } else {
