                                ...
                                imageViewWidth:(CGFloat)imageViewWidth
{
    ...
    return [self ll_CreateNonInterpolatedUIImageFormCIImage:outputImage withSize:imageViewWidth];
}

/** 根据CIImage生成指定大小的UIImage */
+ (UIImage *)ll_CreateNonInterpolatedUIImageFormCIImage:(CIImage *)image withSize:(CGFloat)size
{
...
+ (UIImage *)ll_BarcodeImageWithContent:(NSString *)content
                           codeImageSize:(CGSize)size
                                   ...
                                   green:(CGFloat)green
                                    blue:(CGFloat)blue
{
    UIImage * image               = [self ll_BarcodeImageWithContent:content codeImageSize:size];
...
//改变条形码尺寸大小
+ (UIImage *)ll_BarcodeImageWithContent:(NSString *)content codeImageSize:(CGSize)size
{
    CIImage * image     = [self ll_BarcodeImageWithContent:content];
...
//生成最原始的条形码
+ (CIImage *)ll_BarcodeImageWithContent:(NSString *)content
{
